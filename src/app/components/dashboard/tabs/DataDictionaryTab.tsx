...
const METRICS: Metric[] = [
  ...
  },
  {
    ...
    section: "overview",
    definition: "Percentage of new Slack members (Jul 10–Aug 4) who attended at least one of the 4 GCC calls.",
    calculation: "New members who attended any call ÷ total new members = 22 ÷ 111 = 20%.",
    source: "All 4 Teams attendance reports cross-referenced with Slack member list",
    files: ["Growth Community Call (GCC) - Attendance report 7-14-26.xlsx", "Growth Community Call - Attendance report 7-21-26.xlsx", "Growth Community Call (GCC) - Attendance report 7-28-26.xlsx", "Growth Community Call - Attendance report 8-04-26.xlsx"],
  },
  {
    name: "SharePoint views (Overview)",
    section: "overview",
    definition: "Total all-time SharePoint page views for the Growth Community site.",
    calculation: "All-time site visits from the Overall Traffic sheet: 3,990 total as of Aug 5, 2026.",
    source: "SharePoint site analytics export",
    files: ["SiteAnalyticsData_5-Aug,2026.xlsx", "analytics.json → kpis.sharepoint.pageViews"],
  },
  {
    ...
    calculation: "All-time unique viewer count from SharePoint analytics export: 62 as of Aug 5, 2026.",
    source: "SharePoint site analytics export",
    files: ["SiteAnalyticsData_5-Aug,2026.xlsx", "analytics.json → kpis.sharepoint.uniqueViewers"],
  },
  {
    name: "GCC core members",
    section: "overview",
    definition: "Members who attended all 4 GCC calls (Jul 14, 21, 28, Aug 4) — the highest-engagement segment.",
    calculation: "Intersection of all 4 attendee sets = 7 members: Kristen Yerardi, Jasmine Westbrooks, Nicole Keyes, Greg Bender, Liz Barker, Rithvik Siddam, Otilia Mihai.",
    source: "All four Teams attendance reports",
  ...
  // ── SharePoint ─────────────────────────────────────────────────────────────
  {
    ...
    calculation: "All-time site visits from the Overall Traffic aggregate row: 3,990 as of Aug 5, 2026.",
    source: "SharePoint site analytics export (.xlsx)",
    files: ["SiteAnalyticsData_5-Aug,2026.xlsx → Overall traffic sheet → All time row"],
  },
  {
    name: "Unique viewers",
    section: "sharepoint",
    definition: "Number of distinct authenticated users who viewed at least one page on the site, all time.",
    calculation: "All-time unique viewer count from Overall Traffic sheet: 62 as of Aug 5, 2026.",
    source: "SharePoint site analytics export (.xlsx)",
    files: ["SiteAnalyticsData_5-Aug,2026.xlsx → Overall traffic sheet → All time row"],
  },
  {
    ...
    calculation: "100% desktop visits as of Aug 5, 2026.",
    source: "SharePoint site analytics export (.xlsx) — Usage by device sheet",
    files: ["SiteAnalyticsData_5-Aug,2026.xlsx → Usage by device sheet"],
  },
  {
    ...
    calculation: "4 weekly buckets: Jul 8–14 (327 views, 18 unique), Jul 15–21 (700, 41), Jul 22–28 (728, 43), Jul 29–Aug 4 (923, 64).",
    source: "SharePoint site analytics export (.xlsx) — Overall traffic daily rows, grouped by week",
    files: ["SiteAnalyticsData_5-Aug,2026.xlsx → Overall traffic sheet", "analytics.json → sharepointTrend"],
  ...
  // ── GCC Call Attendance ────────────────────────────────────────────────────
  {
    ...
    files: [
      ...
      "Growth Community Call - Attendance report 8-04-26.xlsx",
    ],
  ...
  },
  {
    ...
    section: "meeting",
    definition: "Cross-reference of 111 new Slack members (Jul 10–Aug 4) against all 4 GCC attendance reports.",
  ...
  {
    name: "Total unique attendees (GCC overview)",
    section: "meeting",
    definition: "Distinct individuals who attended at least one of the 4 GCC calls (Jul 14, 21, 28, Aug 4).",
    calculation: "Union of all four attendee name sets, deduplicated by normalised lowercase name = 146 unique attendees.",
    source: "All four Teams attendance reports",
    files: [
      "Growth Community Call (GCC) - Attendance report 7-14-26.xlsx",
      "Growth Community Call - Attendance report 7-21-26.xlsx",
  ...
  {
    name: "Core members (attended all 4)",
    section: "meeting",
    definition: "Attendees who were present at every one of the 4 GCC calls (Jul 14, 21, 28, Aug 4).",
    calculation: "Intersection of all four attendee name sets, matched by normalised name = 7 members.",
    source: "All four Teams attendance reports",
    files: [
      "Growth Community Call (GCC) - Attendance report 7-14-26.xlsx",
      "Growth Community Call - Attendance report 7-21-26.xlsx",
  ...
  },
  {
    ...
    section: "meeting",
    definition: "How many unique attendees came to exactly which combination of the 4 GCC calls.",
    calculation: "Set logic on the four attendee lists: e.g., 'Aug 4 only' = in Aug 4 set AND NOT in any prior call.",
    source: "All four Teams attendance reports — computed via set operations",
      ...
      <Card className="gap-2 rounded-md border-[var(--border)] bg-[var(--gc-offwhite)] p-4 shadow-none">
        ...
        <div className="grid gap-1 sm:grid-cols-2">
          {[
                ...
                ["Growth Community Call - Attendance report 8-04-26.xlsx",       "Teams attendance report — Aug 4, 2026"],
